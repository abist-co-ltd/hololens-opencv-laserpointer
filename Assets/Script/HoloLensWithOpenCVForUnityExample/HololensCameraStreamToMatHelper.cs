...
namespace HoloLensWithOpenCVForUnity.UnityUtils.Helper
{
    ...
    public delegate void FrameMatAcquiredCallback(Mat mat, Matrix4x4 projectionMatrix, Matrix4x4 cameraToWorldMatrix, CameraIntrinsics camIntrinsics);
	#endif
    ...
    public class HololensCameraStreamToMatHelper : WebCamTextureToMatHelper
    {
        ...
        {
#if ENABLE_WINMD_SUPPORT
            texture.LoadRawTextureData(this.latestImageBytes);
